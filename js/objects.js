...
var io = new Moon('io',true, 2.4129754, 1.76997, .7, 67, ioNote_BUFFER,ioDrum_BUFFER,0.8);
var europa = new Moon('europa',true, 0.0229487, 3.55379, 0.6, 107, europaNote_BUFFER,europaDrum_BUFFER,0.8);
var ganymede = new Moon('ganymede',true, -2.733736 +2*Math.PI,P_ganymede, 1, 170, ganymedeNote_BUFFER, ganymedeDrum_BUFFER,0.8);
var callisto = new Moon('callisto',true, 1.107091,16.68718, 0.9, 300, callistoNote_BUFFER,callistoDrum_BUFFER,2);
